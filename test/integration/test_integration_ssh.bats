...
@test ".integration.ssh.generate_ssh_key - validate ssk-keygen command available and generate keys with right permission" {
...
@test ".integration.ssh.create_ssh_connect_script - Validate SSH Connect Script Generation with multipass (mock)" {
  init_integration_test
